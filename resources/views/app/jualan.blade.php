                        ...
                        <table class="table table-bordered" id="data-produkku" width="100%" cellspacing="0">
                            <thead>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    @if ($p->pesanan_status === 'pending')
                                    <a
                                        href="{{ $p->pesanan_id }}/pengemasan"
                                        class="btn btn-success"
                                    >
                                        <i>Proses Pengemasan</i>
                                    </a>
                                    @endif

                                    @if ($p->pesanan_status === 'pengemasan')
                                    <a
                                        href="{{ $p->pesanan_id }}/pengiriman"
                                        class="btn btn-success"
                                    >
                                        <i>Proses Pengiriman</i>
                                    </a>
                                    @endif
